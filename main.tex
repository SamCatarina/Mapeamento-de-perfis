...
A análise foi complementada com o coeficiente de Silhueta, cujo valor máximo também ocorreu para dois clusters. Embora o valor da silhueta (0,149) seja baixo, o que indica estruturas parcialmente sobrepostas, esse valor é comum em bases de percepção subjetiva e dados sociocomportamentais. Dessa forma, tanto o método do cotovelo quanto o coeficiente de silhueta convergiram para a definição de dois clusters como número ideal.
